...
@section('page_subtitle', 'Crea un insumo para controlar existencias')
        ...
        <form method="POST" action="{{ route('insumos.store') }}" class="space-y-5">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <input name="costo_promedio" value="{{ old('costo_promedio', 0) }}"
                ...
                <div>
                    ...
                    <input name="stock_minimo" value="{{ old('stock_minimo', 0) }}"
