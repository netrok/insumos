    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            ...
            <div class="flex gap-2">
                ...
                <a href="{{ route('almacenes.edit', $item) }}"
                   class="px-4 py-2 rounded bg-blue-600 text-white hover:bg-blue-500">
                    Editar
                </a>

                <form method="POST" action="{{ route('almacenes.destroy', $item) }}"
                ...
                <div class="p-6 space-y-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="md:col-span-2">
                            <div class="text-xs uppercase tracking-wide text-gray-500">Ubicación</div>
                            <div class="mt-1 text-base text-gray-900">{{ $item->ubicacion ?: '—' }}</div>
                        </div>
